...
classifier_config, detector_config = DefaultMunch.fromDict(classifier_config), DefaultMunch.fromDict(detector_config)
...
# -------------------------------- DETECTION LOOP ----------------------------------
url  = "https://192.168.178.69:8080/video" # "test_video/rgb.mp4"
...
while cap.isOpened(): 
    ...
    if active:         
        ...
        # print("best1 {} best2 {}".format(best1, best2))
    ...
    if finished_prediction:
        # print("yo")
        # print(classifier_config.clf_threshold_final)
        best2, best1 = tuple(cum_sum.argsort()[-2:][::1])
